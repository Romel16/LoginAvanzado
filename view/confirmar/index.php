...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Confirmar | AnderCode - Mesa de Partes</title>
                            ...
                            <div class="w-100">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script>Sistemas <i class="mdi mdi-heart text-danger"></i> romelweb.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
