                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <form class="custom-form mt-4 pt-2" action="" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="usuarioCorreo" name="usuarioCorreo" placeholder="Enter username" required>
                                        </div>
                                        <div class="mb-3">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <div class="">
                                                        <a href="view/recuperar/index.php" class="text-muted">¿No te acuerdas la contraseña?</a>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="input-group auth-pass-inputgroup">
                                                <input type="password" class="form-control" id="usuarioPassword" name="usuarioPassword" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon" required>
                                    ...
                                    <div class="mt-4 pt-2 text-center">
                                        <div class="signin-other-title">
                                            <h5 class="font-size-14 mb-3 text-muted fw-medium">- Iniciar Sesion con-</h5>
                                        </div>
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0">¿No tiene una cuenta? <a href="view/registro/index.php" class="text-primary fw-semibold"> Registarate Aquí </a> </p>
                                    </div>
                                </div>
